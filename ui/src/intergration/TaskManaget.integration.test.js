    ...
    it('should have heading', async () => {
     ...
     it('should have first row', async () => {
        render(
         ...
         await delay(1000);
         const columnTask =  screen.getByText('Learn Guitar')
         expect(columnTask).toBeInTheDocument();
         const columnDescription =  screen.getByText(/Have to learn guitar daily for 1 hour/i)
         expect(columnDescription).toBeInTheDocument();
     ...
     it('Edit Modal Should be working', async () => {
        render(
         ...
         const row = screen.getByRole('row', {
            name: /learn guitar have to learn guitar daily for 1 hour incomplete edit delete/i
          });
